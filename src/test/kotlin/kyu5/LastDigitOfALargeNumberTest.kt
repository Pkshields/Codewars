...
class LastDigitOfALargeNumberTest {
    ...
    fun `Basic Tests`() {
        ...
        assertEquals(9, lastDigit(BigInteger("32432082738189381619766143368298739609969587994867031072552313202412697"), BigInteger("81910501089111675677660854211457453898")))
    }
}